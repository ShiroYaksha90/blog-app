...
RSpec.describe User, type: :model do
  user = User.new(name: 'Basim', photo: 'https://images.app.goo.gl/myphSgUZVGsHqcsk8', bio: 'Software engineer',
                  posts_counter: 7)
  ...
  it 'fetch the last three posts' do
    ...
    user.posts.create!(title: 'Post 2', text: 'Second post', likes_counter: 3, comments_counter: 1)
    user.posts.create!(title: 'Post 3', text: 'Third post', likes_counter: 3, comments_counter: 1)
